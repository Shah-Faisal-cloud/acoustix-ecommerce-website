...
export default function ProductCard({ id, category, name, imagesObj, isNew, description }) {
  ...
  return /* html */ `
    <div class="product-card" id="${id}">
      <div class="product-card__image-container">
        <picture>
          <source media="(min-width: 1024px)" srcset="${imagesObj.desktop}">
        <source media="(min-width: 768px)" srcset="${imagesObj.tablet}">
        <img src="${imagesObj.mobile}" alt="${name}" class="product-card__image" >
        </picture>
      </div>
